...
], OwnerController.prototype, "getUsers", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], OwnerController.prototype, "get", null);
__decorate([
    routing_controllers_1.Post("/"),
    __param(0, routing_controllers_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Owner_1.Owner]),
    __metadata("design:returntype", void 0)
], OwnerController.prototype, "save", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], OwnerController.prototype, "delete", null);
__decorate([
    routing_controllers_1.Put("/:id"),
    __param(0, routing_controllers_1.Param("id")), __param(1, routing_controllers_1.Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Owner_1.Owner]),
    __metadata("design:returntype", void 0)
], OwnerController.prototype, "update", null);
OwnerController = __decorate([
    typedi_1.Service(),
    routing_controllers_1.JsonController("/owners"),
    __metadata("design:paramtypes", [OwnerRepository_1.OwnerRepository])
], OwnerController);
